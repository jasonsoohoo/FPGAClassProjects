...
HD_PWD='C:/Users/jtsoo/SooHooCPE133Lab8/SooHooCPE133Lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1SequenceDetectorPlus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Problem1SequenceDetectorPlus.tcl -notrace
