...
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[6]}]
#set_property PACKAGE_PIN W6 [get_ports {sLED[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[5]}]
#set_property PACKAGE_PIN U8 [get_ports {sLED[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[4]}]
#set_property PACKAGE_PIN V8 [get_ports {sLED[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[3]}]
#set_property PACKAGE_PIN U5 [get_ports {sLED[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[2]}]
#set_property PACKAGE_PIN V5 [get_ports {sLED[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[1]}]
#set_property PACKAGE_PIN U7 [get_ports {sLED[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sLED[0]}]

#set_property PACKAGE_PIN V7 [get_ports dp]							
#	set_property IOSTANDARD LVCMOS33 [get_ports dp]

#set_property PACKAGE_PIN U2 [get_ports {sANO[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sANO[0]}]
#set_property PACKAGE_PIN U4 [get_ports {sANO[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sANO[1]}]
#set_property PACKAGE_PIN V4 [get_ports {sANO[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sANO[2]}]
#set_property PACKAGE_PIN W4 [get_ports {sANO[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sANO[3]}]
