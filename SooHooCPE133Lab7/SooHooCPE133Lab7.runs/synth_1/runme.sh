...
HD_PWD='C:/Users/jtsoo/SooHooCPE133Lab7/SooHooCPE133Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1FSMSequencer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Problem1FSMSequencer.tcl
