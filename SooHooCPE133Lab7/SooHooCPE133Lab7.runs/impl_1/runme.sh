...
HD_PWD='C:/Users/jtsoo/SooHooCPE133Lab7/SooHooCPE133Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1FSMSequencer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Problem1FSMSequencer.tcl -notrace
